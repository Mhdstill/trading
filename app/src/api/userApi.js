import { API_BASE_URL, callApi } from './api'; // Assurez-vous d'importer callApi et API_BASE_URL depuis api.js
...
export const login = async (email, password) => {
    try {
        ...
        // Stockez le token dans le stockage local (localStorage)
